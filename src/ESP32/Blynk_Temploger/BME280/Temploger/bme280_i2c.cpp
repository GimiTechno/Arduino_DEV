...
void bme280_i2c_main(bme280_data_t *p_bme280_data_t)
{
    ...
    p_bme280_data_t->temperature = temp_act;
    p_bme280_data_t->humidity    = hum_act;
    p_bme280_data_t->pressure    = press_act;

#if 1
    Serial.println("--------------------------");
    Serial.print("Temp = ");
    Serial.print(p_bme280_data_t->temperature);
    Serial.println(" 'C ");

    Serial.print("Humidity = ");
    Serial.print(p_bme280_data_t->humidity);
    Serial.println(" % ");

    Serial.print("Pressure = ");
    Serial.print(p_bme280_data_t->pressure);
    Serial.println(" hPa ");
